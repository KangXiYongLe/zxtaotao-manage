	    ...
	    <table cellpadding="5">
	        ...
	        <tr>
	            ...
	            <td>
	            	...
	            	<a href="javascript:void(0)" class="easyui-linkbutton picFileDelete">删除图片</a>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$(".picFileDelete").click(function(e){
	...
	function picDelete(id){
		...
		$.ajax({
		   ...
		   statusCode: {204: function() {
			   $(".picFileUpload").siblings(".pics").find("ul").empty();
			   /*  $.messager.alert('提示','图片删除成功!'); */
			  },
			  500: function() {
				$.messager.alert('提示','图片删除失败!');
			  }
		   }		   
		});
	}
